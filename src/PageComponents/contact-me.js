        ...
        <div className="contact__page">
          <div className="contact">
            ...
            <div className="social-links">
              <a href="https://www.linkedin.com/in/maysen-greenwood/" target="_blank" rel="noreferrer"><LinkedIn fontSize="large" style={{fill: "#0e76a8"}}/></a>
              <a href="https://www.facebook.com/maysen.greenwood/" target="_blank" rel="noreferrer"><Facebook fontSize="large" style={{fill: "#4267B2"}}/></a>
            </div>
          </div>
          <Form
            validated={validated}
